...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editFighterModal<?php echo $fighter['fighter_id']; ?>">
...
<!-- Modal -->
<div class="modal fade" id="editFighterModal<?php echo $fighter['fighter_id']; ?>" tabindex="-1" aria-labelledby="editFighterModalLabel<?php echo $fighter['fighter_id']; ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editFighterModalLabel<?php echo $fighter['fighter_id']; ?>">Edit Fighter</h1>
